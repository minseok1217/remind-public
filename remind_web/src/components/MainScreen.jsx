        ...
        <div className="top-row">
          ...
          <div className="card-section">
            ...
            <div className="today-card">
              <div className="today-card-content">
                <div className="today-card-text">오늘 통화 완료</div>
                <div className="today-card-desc">오늘 통화를 완료하였어요!</div>
                <div className="today-card-desc">목소리가 평소보다 밝게 들렸어요!</div>
              </div>
          ...
          <div className="card-section">
            ...
            <div className="status-card">
              <p className="section-desc">최근 일주일간 통화를 분석했습니다.</p>
              <div className="status-header">
                <div>
                  <div className="status-label">전반적인 상태</div>
                  <div className="status-text">매우 양호</div>
                </div>
                <div className="status-score">{cognitiveStatus.score}<span class="score-unit">점</span></div>
              </div>
